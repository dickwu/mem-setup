---
name: mem-load
description: Auto-load domain knowledge at task start. Reads /knowledge/INDEX.md, finds relevant domain folders for the current task, loads rules.md (apply by default) and hypotheses.md (check if testable). This skill is auto-triggered via CLAUDE.md — you should also invoke it manually when switching domains mid-conversation or when you realize you're working in a domain you haven't loaded yet.
---
...
5. **Brief the user** — one-line summary of what you loaded:
